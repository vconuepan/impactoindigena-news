...
import { authLimiter, accountAuthLimiter, refreshLimiter } from '../middleware/rateLimit.js'
...
router.post('/login', authLimiter, accountAuthLimiter, validateBody(loginSchema), async (req, res) => {
  try {
