...
export const JOB_DISPLAY_NAMES: Record<JobName, string> = {
  ...
  facebook_update_metrics: 'Facebook Metrics',
  instagram_refresh_token: 'Instagram Token Refresh',
  linkedin_check_token: 'LinkedIn Token Check',
  facebook_check_token: 'Facebook Token Check',
